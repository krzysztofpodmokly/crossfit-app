...
class ForWeight extends React.Component {
    render() {
        return (
            <div className="row">
                <div className="col s6">
                    <div className="input-field">
                        ...
                        <input type="text" id={`content-${this.props.index}`}  value={this.props.forweight} autoComplete="off" onChange={(e) => this.props.handleInputContentChange(e, this.props.index)}/>
                    </div>
                </div>
                <div className="col s6">
